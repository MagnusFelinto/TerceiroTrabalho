...
public class AgendamentoService {
    ...
    public Agendamento editarReserva(Long agendaId) {
        Agendamento Agendamento = AgendamentoRepository.findById(agendaId)
                .orElseThrow(() -> new EntidNaoEncotradaExepstion("Agendamento não encontrado"));
        Agendamento.setStatus(Reserva.AGENDADA);
        return AgendamentoRepository.save(Agendamento);
    }

    public AgendamentoModel editar( Long agendaId, AgendamentoEditarInput agendamentoInput) {
